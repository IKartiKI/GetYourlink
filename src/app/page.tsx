...
import landingPageImg from '../../public/demo.png'
...
export const siteConfig = {
  name: "GetYourLink - one page, many links.",
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-[5.3rem]">Take control of your links with GetYourLink</h1>
                ...
                <div>
                    <Image className="w-1/2 h-auto mx-auto" src={landingPageImg} alt="heroImg" />
                </div>
            </div>
        </div>
    </section>
